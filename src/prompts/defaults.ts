// Default prompt templates — written to ~/.inkai/prompts/ on first run.
// Users can edit those files to customise how inkai talks to LLMs.
// Variables use {{varName}} syntax. Conditionals use {{#if varName}}...{{/if}}.
...
- "summary-of-chapters.md": Start with "No chapters written yet." and outline the planned structure/arc.
